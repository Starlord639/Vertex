...
- The Windows installer uses the Vertex icon.
...
- OMP's native commands and custom workflows appear in the `/` picker, with descriptions and argument hints. Commands run through OMP with their arguments intact, and workflow dialogs support choosing options and entering text. Vertex keeps `/plan` and `/compact`; use `/omp:plan` and `/omp:compact` for OMP's versions.
- The `@` file picker supports files and folders whose paths contain spaces and refreshes when the workspace changes, so newly created paths appear without restarting Vertex. Unsafe control and bidirectional formatting characters are excluded from mention tokens. In #67 by @elanchezhiyanr.
...
- After an in-app update, Vertex shows a notification with a **What's new** action. It opens the bundled notes in a read-only tab only when requested. The notes remain available under Settings → General → About.
...
- Grok Build joins the provider list. Install it with `curl -fsSL https://x.ai/cli/install.sh | bash` and run `grok login` (or set `XAI_API_KEY`). Vertex runs `grok agent stdio` like the other ACP harnesses: live turns, supervised approvals, model catalog, reasoning effort, context usage, skills from `.grok/skills`, and titles / commit / PR text.
...
- Settings → Appearance: System theme. The picker was Dark and Light only, so the app never followed the OS. System tracks the appearance while Vertex is open; Dark stays the default, so existing installs do not flip. In #36 by @emircan-sahin.
...
- Claude Code hooks now run. Vertex used to launch the CLI with `disableAllHooks`, so every hook in your `settings.json` — command rewrites, blocks, notifications — was silently skipped. Settings → General has a "Claude Code hooks" toggle (on by default) to turn them back off if one misbehaves. Vertex's own helper spawns, like title generation, stay hook-free. In #25.
...
- GitHub inbox and `gh` subprocesses work when Vertex is launched from Finder, by resolving the CLI through the login-shell PATH the same way harnesses do.
...
- Linear personal API keys stay on this Mac: written to the app data folder (`~/Library/Application Support/com.vertex.desktop/linear-token`) with owner-only permissions (`0600`). They are sent only to Linear's API to list and read issues, never to Vertex servers, and never placed in the agent prompt. Disconnect deletes the file. GitHub uses the `gh` login already on the machine; Vertex does not store a GitHub token.
...
- omp ([oh-my-pi](https://omp.sh)) joins the provider list. Install it with `curl -fsSL https://omp.sh/install | sh` and log in, and Vertex runs it like any other harness: live turns, steering, approvals, model catalog, and skills from `.omp/skills`.
...
- Provider CLIs installed through a Node version manager (nvm, fnm, mise, Volta) no longer show as unavailable when Vertex is launched from Finder. Detection reads PATH from an interactive login shell, so anything set up in `.zshrc` is found, and a disabled provider now says its CLI was not found instead of implying it needs to be authenticated.
- Codex works when only the Codex desktop app is installed. Vertex falls back to the CLI bundled inside `Codex.app` when no standalone `codex` is on PATH, preferring a real install whenever one exists.
...
[Unreleased]: https://github.com/hardbeat920/vertex/compare/v0.1.35...HEAD
[0.1.35]: https://github.com/hardbeat920/vertex/compare/v0.1.34...v0.1.35
[0.1.34]: https://github.com/hardbeat920/vertex/compare/v0.1.33...v0.1.34
[0.1.33]: https://github.com/hardbeat920/vertex/compare/v0.1.32...v0.1.33
