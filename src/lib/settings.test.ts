...
const KEY = "vertex.composerRunner";
const NOTES_KEY = "vertex.notesEnabled";
const LIVE_AGENTS_KEY = "vertex.liveAgentsEnabled";
const GRID_ARCADE_KEY = "vertex.gridArcadeEnabled";
