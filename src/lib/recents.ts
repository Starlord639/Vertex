...
const KEY = "vertex.recentProjects";
const RAIL_ORDER_KEY = "vertex.projectRailOrder";
const RAIL_PINNED_KEY = "vertex.projectRailPinned";
const ARCHIVED_KEY = "vertex.archivedProjects";
const ARCHIVED_CHANGED = "vertex:archived-projects-changed";
const MAX = 20;
