...
const FAVORITES_KEY = "vertex.favoriteModels";
const MODEL_PICKER_TAB_KEY = "vertex.modelPickerTab";
const HIDDEN_PICKER_PROVIDERS_KEY = "vertex.hiddenPickerProviders";
const LAST_MODEL_KEY = "vertex.lastModel";
const LAST_MODEL_SETTINGS_KEY = "vertex.lastModelSettings";
const DEFAULT_MODELS_KEY = "vertex.defaultModels";
