...
const COLOR_KEY = "vertex:tab-group:colors";
const CUSTOM_COLOR_KEY = "vertex:tab-group:custom-colors";
const LABEL_KEY = "vertex:tab-group:labels";
const LOGO_KEY = "vertex:tab-group:logos";
const MASCOT_KEY = "vertex:tab-group:mascots";

const HEX_COLOR_RE = /^#[0-9a-fA-F]{6}$/;

export const TAB_GROUP_LOGOS_CHANGED = "vertex:tab-group-logos-changed";
...
const KEY_VERSION_KEY = "vertex:tab-group:key-version";
const KEY_VERSION = "2";
...
const COLLAPSED_KEY = "vertex:tab-groups:collapsed";
