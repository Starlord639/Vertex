...
const SECTION_KEY = "vertex.settingsSection";
...
export const SETTINGS_SECTIONS: {
  ...
  },
  {
    ...
    label: "Providers",
    description:
      "Agent CLIs Vertex can drive, and the model new sessions start with.",
  },
  {
    id: "archive",
    label: "Archive",
...
const COMPOSER_RUNNER_KEY = "vertex.composerRunner";

const FOLLOW_UP_BEHAVIOR_KEY = "vertex.followUpBehavior";
...
export const COMPOSER_RUNNER_CHANGE_EVENT = "vertex:composer-runner-change";
...
const NOTES_ENABLED_KEY = "vertex.notesEnabled";

export const NOTES_ENABLED_DEFAULT = true;

/** Fired on `window` when the Notes UI setting flips. */
export const NOTES_ENABLED_CHANGE_EVENT = "vertex:notes-enabled-change";
...
const LIVE_AGENTS_ENABLED_KEY = "vertex.liveAgentsEnabled";
...
export const LIVE_AGENTS_ENABLED_CHANGE_EVENT =
  "vertex:live-agents-enabled-change";
...
const GRID_ARCADE_ENABLED_KEY = "vertex.gridArcadeEnabled";
...
export const GRID_ARCADE_ENABLED_CHANGE_EVENT =
  "vertex:grid-arcade-enabled-change";
...
const DIFF_VIEWER_KEY = "vertex.diffViewer";
...
export const DIFF_VIEWER_CHANGE_EVENT = "vertex:diff-viewer-change";
...
const CLAUDE_HOOKS_KEY = "vertex.claudeHooks";
