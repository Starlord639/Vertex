...
const THEME_HUE_KEY = "vertex.themeHue";
const THEME_SATURATION_KEY = "vertex.themeSaturation";
const OPACITY_KEY = "vertex.sidebarOpacity";
const BLUR_KEY = "vertex.sidebarBlur";
const PROJECT_RAIL_OPEN_KEY = "vertex.projectRailOpen";
const BODY_KEY = "vertex.bodyGlass";
const SCHEME_KEY = "vertex.colorScheme";
const SIDEBAR_TAB_ORDER_KEY = "vertex.sidebarTabOrder";
const PROJECT_RAIL_WIDTH_KEY = "vertex.projectRailWidth";
const TRANSCRIPT_LAYOUT_KEY = "vertex.transcriptLayout";
const TRANSCRIPT_ANCHOR_KEY = "vertex.transcriptAnchor";
...
export const SCHEME_CHANGE_EVENT = "vertex:schemechange";
...
export const TRANSCRIPT_ANCHOR_CHANGE_EVENT = "vertex:transcriptanchorchange";

/** Fired on `window` whenever the transcript layout flips (detail: TranscriptLayout). */
export const TRANSCRIPT_LAYOUT_CHANGE_EVENT = "vertex:transcriptlayoutchange";
