...
function GeneralPage({
  ...
  return (
    <>
      ...
      <Row
        label="Notifications"
        description="Notify when an agent finishes or needs input in another session or while Vertex is in the background. Click the notification to open that session."
      >
        ...
        : snapshot.phase === "checking"
          ...
          : snapshot.phase === "current"
            ...
            : snapshot.phase === "error"
              ...
              : "Vertex updates itself from the release feed.";
