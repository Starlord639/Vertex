...
pub const CLICK_EVENT: &str = "vertex:notification-click";
...
mod platform {
    ...
    const CATEGORY: &str = "vertex.session";
    const SHOW_ACTION: &str = "vertex.session.show";
    ...
    define_class!(
        ...
        #[name = "VertexNotificationDelegate"]
        #[ivars = DelegateIvars]
        struct Delegate;
